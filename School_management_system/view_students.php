...
{
    $sql = "SELECT s.student_id, s.gr_no, s.name, s.father_name, s.dob, s.date_of_admission, s.contact, s.fees_applied, s.class
            FROM students s
        ...
        <div class="row nop justify-content-center mb-3">
            <div class="col-lg-8 col-md-10">
                <div class="p-3 bg-info text-white rounded total-students-info text-center shadow-sm">
                    <h5 class="mb-0">
                        <i class="fas fa-users me-2"></i> Total Active Students:
                ...
                <tbody>
                    ...
                    if (!empty($active_students)) {
                        foreach ($active_students as $row) {
                            ...
                            $rowClass = ($student_id > 16830) ? "highlight-row" : "";
                            ...
                            echo "<tr class='{$rowClass}'>
                             ...
                             <td>{$dob}</td>
                                ...
                                <a href='each_student.php?id={$student_id}' 
    ...
    <script>
        ...
        function filterTable() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                const searchableColumns = [1, 2, 3, 4, , 5, 6, 7, , 8, 9];
